...
# Grain: time_key × product_key × partner_key × flow_type × source_system
...
_SQL_UPSERT_FACT_TRADE = text("""
    ...
    INSERT INTO dds.fact_trade_transaction (
        ...
        fta_keys, flow_type, source_system,
    ...
    ON CONFLICT (time_key, product_key, partner_key, flow_type, source_system)
    DO UPDATE SET
